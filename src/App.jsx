...
class App extends Component {
  ...
  //guardar punto 6
  guardar(e) {
    e.preventDefault(); //sin el preventDefault las acciones dentro de la pagina web no funcionaran
    ...
    if (cod > 0) {
      ...
      axios
        ...
        .then((res) => {
          this.state.series.push(res.data); //push agrega un valor a la data
          var temp = this.state.series;
          this.setState({
            id: 0,
            nombre: "",
